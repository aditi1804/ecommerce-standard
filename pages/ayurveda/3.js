      ...
      <section className="text-gray-600 body-font">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
            <img className="object-cover object-center rounded" alt="hero" src="https://i.ibb.co/JmCktyP/7506a8231c052337e561e25afbe1418a.jpg" />
          </div>
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Brought up Just for You!
              <br className="hidden lg:inline-block" />The Ultimate Skin Care Essentials
            </h1>
            <p className="mb-8 leading-relaxed"> 1500/-<br />
                Make sure to grab an alcohol-free toner. Serum. Serums, or treatments, hydrate and protect your skin.Witness the healing touch of nature through Kama Ultimate Skin Care Products</p>
