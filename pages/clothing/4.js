        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Handcrafted Just for You!
              <br className="hidden lg:inline-block" />Kashmiri Woolen Kurta
            </h1>
            <p className="mb-8 leading-relaxed"> Rs. 1500/- only.
                Buy 100% authentic Kashmiri cotton Kurtis online in India. Cotton Aari work kurtas, Silk Kurtis and multicolor embroidered Kurti.</p>
