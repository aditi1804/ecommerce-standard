      ...
      <section className="text-gray-600 body-font">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
            <img className="object-cover object-center rounded" alt="hero" src="https://i.ibb.co/bFBXbkY/f083d1fa0aff8d40f9faba4f5c7f0abd.jpg" />
          </div>
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Brought up Just for You!
              <br className="hidden lg:inline-block" />Pure Senna Leaves Tea Powder
            </h1>
            <p className="mb-8 leading-relaxed"> 250/- for 75g <br />
                Senna tea is a popular herbal remedy that's often marketed as a laxative, weight loss aid, and detox method</p>
